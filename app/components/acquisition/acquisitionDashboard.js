(function() {
     ...
     * under the License.
     */
    angular.module('administration').controller('AcquisitionDashboardController', ['$scope', 'administrationServices', 'administrationAPI', 'CONFIG', acquisitionDashboardController]);
            ...
            $scope.getHistory = function(concatData) {
                ...
                administrationAPI.getHistory(options, function(data) {
                    ...
                    for(var j = 0; j<$scope.history.length; j++){
                        ...
                        $scope.history[j]['status'] = status[Math.floor((Math.random() * 7))];
                    }
