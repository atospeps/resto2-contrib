(function() {
    ...
    angular.module('administration').controller('AcquisitionPriorityController', ['$scope', 'administrationServices', 'administrationAPI', 'CONFIG', AcquisitionPriorityController]);

    function AcquisitionPriorityController($scope, administrationServices, administrationAPI, CONFIG) {
