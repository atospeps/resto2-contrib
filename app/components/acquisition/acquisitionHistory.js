(function() {
    ...
    angular.module('administration').controller('AcquisitionHistoryController', ['$scope', 'administrationServices', 'administrationAPI', 'CONFIG', acquisitionHistoryController]);
